...
def vibrations(speed, mass, grade):
    # setup the parameters
    omega = 10 #forcing frequency
    velocity = speed     #6.1 #4.73 #6.53 1st route #speed of bike in meters per second
    #springs
    k1 = 120000 #Rear Tire stiffness ############ Hard Tire-rim-high pressure
    k2 = 170500 # Rear triangle 
    k3 = 120000 # front tire stiffness  ########### Hard tire-rim-high pressure
    ...
    m5=1.5 #handlebars 
    m6= 0.4069*mass #32.15  #25.05  #42.58  #humanbody, larger portion ##############
    m7= 0.185*mass #14.668  #12.28 #17.28  #arms portion of body    ######
    I_i=5 #
    #Bike dimensions
    ...
    P1 = []
    for t in np.arange(0, N, 1):
        phi_new = g_d[grade]*0.000001 * ((O2[t])/1)**(-m) # ([rad/m] / [rad/m])
        phi = round(phi_new, 4)
        P1.append(phi)
...
####################
    ...
    #plt.show()
    return F2, problem, problem2, time, G6, G7, A1_rms, A2_rms, Z_rms
